...
import com.school.schooldeal.message.server.SealAction;
import com.school.schooldeal.message.server.network.async.AsyncTaskManager;
import com.school.schooldeal.message.server.network.async.OnDataListener;
    ...
    public void onFailure(int requestCode, int state, Object result) {
        switch (state) {
            ...
            case AsyncTaskManager.HTTP_NULL_CODE:
                ToastUtil.makeShortToast(mContext, "当前网络不可用");
                break;

            // 网络有问题给出提示
            case AsyncTaskManager.HTTP_ERROR_CODE:
                ToastUtil.makeShortToast(mContext, "网络问题请稍后重试");
                break;
