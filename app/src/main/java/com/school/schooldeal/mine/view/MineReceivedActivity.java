...
public class MineReceivedActivity extends BaseActivity {
    ...
    public void initviewPager(){
        ...
        fragmentList.add(new MineReceivedStoreFragment());
        fragmentList.add(new MineReceivedSchoolFragment());
